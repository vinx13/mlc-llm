...
class RequestModelStateNode : public Object {
 public:
   ...
   * \param draft_token_manager The optional draft token workspace manager to release the slots if
   * provided.
   */
  void RemoveAllDraftTokens(DraftTokenWorkspaceManager* draft_token_manager);
