...
void RequestModelStateNode::RemoveAllDraftTokens(DraftTokenWorkspaceManager* draft_token_manager) {
  if (draft_token_manager != nullptr) {
    (*draft_token_manager)->FreeSlots(draft_token_slots);
  }
