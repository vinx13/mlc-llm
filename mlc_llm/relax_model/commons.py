...
def _get_moe_shard_strategies(
    num_shards: int, param_shape_is_already_sharded: bool
...
def _get_shard_strategies(
    ...
    shard_strategies.update(_get_moe_shard_strategies(num_shards, param_shape_is_already_sharded))
    return shard_strategies
